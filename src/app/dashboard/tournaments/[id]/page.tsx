...
export default function TournamentAdminPage() {
  ...
  const totalPricePerPlayer =
    ...
    (tournament.settings?.systemTechFee ?? DEFAULT_SERVICE_FEE);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {(([
          ...
          ...(isSuperAdmin ? [{ label: 'Service Fees', value: formatCurrency((tournament.settings?.systemTechFee ?? DEFAULT_SERVICE_FEE) * players.length) }] : []),
