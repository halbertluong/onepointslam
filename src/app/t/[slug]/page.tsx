...
import { DEFAULT_SERVICE_FEE } from '@/lib/pricing';
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      >
        ...
        <p className="mt-2 text-white/80 text-lg">One Point Bowl · Tennis Tournament Platform</p>
      </div>
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      {isOpen ? (
                        ...
                        >
                          Register — ${(t.settings?.ticketPriceForFundraiser ?? 0) + (t.settings?.systemTechFee ?? DEFAULT_SERVICE_FEE)}
                        </Link>
                      ) : (
