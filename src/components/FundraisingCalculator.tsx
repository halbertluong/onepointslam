...
import { calcGoalBased, calcPlayerBased, formatCurrency, DEFAULT_SERVICE_FEE } from '@/lib/pricing';
      ...
      */}
      ...
      <div className="flex items-start gap-2.5 bg-slate-50 border border-slate-200 rounded-xl px-4 py-3">
        ...
        <p className="text-xs text-slate-500 leading-relaxed">
          A <strong className="text-slate-700">{formatCurrency(DEFAULT_SERVICE_FEE)} service fee per registrant</strong> is
